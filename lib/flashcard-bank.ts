...
export const flashcards: Flashcard[] = [
  {
    ...
    memory_tip: 'Think "a bear ran" - unusual behavior for a bear to run away',
  ...
  },
  {
    ...
    memory_tip: 'Ben is violent? No! Ben is benevolent - kind and good.',
  ...
  },
  {
    ...
    memory_tip: 'A candid camera captures the truth - honest and real.',
    category: 'Character Traits',
    frequency_score: 8,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Desert + late = desolate - a desert is empty and barren.',
  ...
  },
  {
    ...
    memory_tip: 'E-labor-ate - lots of labor went into making it detailed.',
    category: 'Descriptive',
    frequency_score: 9,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Fortune + us = fortuitous - fortune smiled upon us by chance.',
    category: 'Academic Vocabulary',
    frequency_score: 5,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Greg is gregarious - he loves hanging out with groups.',
    category: 'Character Traits',
    frequency_score: 6,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Hot + tea = haughty - acting too good for others, nose in the air.',
    category: 'Character Traits',
    frequency_score: 7,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Im + mutable = immutable - not able to be changed.',
    category: 'Academic Vocabulary',
    frequency_score: 5,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Jubilant sounds like "jub-i-lant" - jumping for joy!',
    category: 'Emotions',
    frequency_score: 7,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Kinetic = motion, like kinetic energy in physics class.',
    category: 'Science',
    frequency_score: 8,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Lucid like "light" - clear and bright understanding.',
  ...
  },
  {
    ...
    memory_tip: 'Magn-animous = great soul - big-hearted and generous.',
    category: 'Character Traits',
    frequency_score: 5,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Non-chalant = not chalant (not worried) - casual and cool.',
    category: 'Character Traits',
    frequency_score: 6,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z'
  },
  {
    ...
    memory_tip: 'Obsolete = "obstacle to modern life" - old and outdated.',
